  ...
  for (ii = 0; ii < inum; ii++) {
    ...
    for (jj = 0; jj < jnum; jj++) {
      ...
      if (rsq < cutsq[itype][jtype]) {
        ...
        // tt damping function is  "1.0 - beta*gamma"
        // full energy contribution is substracted and replaced by scaled one: "(1.0 - beta*gamma - 1.0)*factor_coul"
        // same for force factor
